...
export default function ViewOutletRevenueModal({ no, cancel, data }) {
  ...
  const [dataToView, setDataToView] = useState([
    ...
    { label: "Outlet Name", value: mainData[0].outletName },
    { label: "Work Shift", value: mainData[0].workShift },
    { label: "Payment Method", value: mainData[0].paymentMethod },
    { label: "Total Items", value: mainData[0].totalItems },
    { label: "Total Cost", value: mainData[0].totalCost },
    { label: "Transaction Date", value: mainData[0].transactionDate },
  ]);
